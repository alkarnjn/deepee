...
r"""The following code taken verbatim from 
https://github.com/pytorch/opacus/blob/master/opacus/privacy_analysis.py under 
...
def compute_rdp(
    ...
    if isinstance(orders, float):
        ...
        rdp = np.array([_compute_rdp(q, noise_multiplier, order) for order in orders])  # type: ignore
